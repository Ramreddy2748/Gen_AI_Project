...
\midrule
Sample rate & Every 5th frame & Every 15th frame \\
Max frames & 60 & 30 \\
Stride & 1 & 3 \\
...
\addplot[fill=green!60] coordinates {
    ...
    (41.7,Enhanced) (58.3,Few-Shot) (62.5,DeepSeek FS) (84.0,XAI)
    (85.4,RAG) (93.8,LoRA) (95.8,Safety-First)
};
\end{axis}
\end{tikzpicture}
\caption{Fall Recall by Strategy. Safety-First achieves 95.8\% recall.}
...
\begin{itemize}[leftmargin=*]
    ...
    \item \textbf{XAI Video-Level} achieves best balance (Macro F1 = 0.820)
